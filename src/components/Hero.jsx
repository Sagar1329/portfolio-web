...
const Hero = () => {
    return (
        <section id="about" className="section-shell overflow-hidden relative">
            ...
            <div className="relative grid lg:grid-cols-[1.35fr_0.65fr] gap-5 md:gap-6 items-center">
                <motion.div
                ...
                >
                    ...
                    <h1 className="mt-3 text-3xl md:text-5xl font-extrabold leading-tight text-slate-100">
                        {about.name}
                    </h1>

                    <p className="mt-1.5 text-base md:text-xl font-semibold text-cyan-200">{about.role}</p>

                    <p className="mt-3 text-slate-300 leading-relaxed max-w-2xl">{about.description}</p>
                ...
                >
                    <div className="w-44 h-44 md:w-52 md:h-52 rounded-[1.6rem] p-[2px] bg-gradient-to-br from-cyan-300 via-sky-300 to-emerald-300">
