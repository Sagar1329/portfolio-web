        ...
        <section id="freelance" className="section-shell">
            ...
            <div className="grid lg:grid-cols-2 gap-3">
                {freelanceWork.map((item) => (
                    <article key={item.client} className="rounded-xl border border-slate-700 bg-slate-900/55 p-4">
                        <div className="flex items-start justify-between gap-3">
                            <div>
                                <h3 className="text-slate-100 text-base md:text-lg font-heading">{item.client}</h3>
